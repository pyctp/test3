...
BROKER_ID, INVESTOR_ID, PASSWORD, ADDR_MD, ADDR_TD = getAccountinfo(r'D:\qhreal\test\conf\simnow24_ctp.json')
...
while True:
    ...
    if not q_depth_market_data.empty():
        ...
        if lastsig == 'BK':
            ...
            print('当前信号:', lastsig, '信号价:', buysigprice, tick.LastPrice, '盈利价差:', bkprofit, '最大:', bkpmax, '最小', bkpmin, '持续周期:', be_apart_from(buysigdetail))
