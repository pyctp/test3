...
'''
inst_strategy = {#'hc1805': {'strategy':'StrategyAvpGrid','volume':2},
                 'rb1805': {'strategy':'StrategyAvpGrid','volume':3},
                 #'j1805': {'strategy':'StrategyFariyFour'}
                 }
...
OPEN,HIGH,LOW,CLOSE = list(range(4))
